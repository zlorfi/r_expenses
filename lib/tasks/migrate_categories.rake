namespace :migrate do
  ...
  task :create_categories do
    ...
    Category.create(short_name_de: 'Genießen', long_name_de: 'Genußmittel', long_name_en: 'supplements')
    ...
    Category.create(short_name_de: 'Apotheke', long_name_de: 'Apotheke', long_name_en: 'pharma')
